...
This is my bot, which won the [infinibattle 2023](https://infi.nl/nieuws/infinibattle-23/). It uses a [Monte-Carlo tree search (MCTS)](https://en.wikipedia.org/wiki/Monte_Carlo_tree_search) with ε-greedy exploration to play Barrage stratego.
